...
function getRandomPumpkinLocations(num)
    ...
    -- Ensure we don't try to get more locations than available
...
function StartAutumnEvent()
    ...
    print("[Herbst-Event] Neue Kürbis-Positionen gesetzt.")
end
...
AddEventHandler("autumn_event:findPumpkin", function(pumpkinIndex)
    ...
    -- Here you might want to save found pumpkins to DB to make them persistent
