...
-- Funktion zum Starten der Hitzewelle auf dem Server
RegisterServerEvent("start_heatwave")
AddEventHandler("start_heatwave", function()
    -- Hitzewelle starten und Spielern die Effekte mitteilen
    TriggerClientEvent("start_heatwave", -1)  -- Alle Spieler werden benachrichtigt
end)
